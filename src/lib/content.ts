...
/* ── 설계의뢰 퍼널: 리드마그넷(자가진단표) ──────────────────
   근거: funnel/research/08_lead-magnet.md, 07_hook-story-offer.md */
export const checklistContent = {
  headline: "이 땅에 공장, 지을 수 있을까요?",
  subheadline: "계약 전에 무료로 확인하세요",
  intro:
    "건축주님 대부분이 \"이 땅에 뭘 지을 수 있는지\"부터 막막해하십니다. 계약 전에 꼭 확인해야 할 9가지를 체크리스트로 정리했습니다. 땅을 이미 갖고 계셔도, 아직 알아보는 중이셔도 도움이 됩니다.",
  items: [
    "토지 용도지역 확인 (계획관리지역 / 생산관리지역 / 농림지역 등)",
    "지목 확인 (전·답·임야·대 등 — 공장 건축 가능 여부)",
    "진입로 확보 여부 (폭 4m 이상 도로 접함)",
    "개발행위허가 필요 여부",
    "건폐율·용적률 확인",
    "인접 용도 확인 (주거지역 인접 시 이격거리 등)",
    "상하수도·전기 인입 가능 여부",
    "업종별 규제 확인 (위험물 저장 등 소방 관련)",
    "환경영향평가 대상 여부 (일정 규모 이상)",
  ],
  formTitle: "공장부지 인허가 자가진단표, 무료로 받아보세요",
  ctaLabel: "자가진단표 무료로 받기",
  interestOptions: [
    { id: "factory", label: "공장" },
...
export const checklistThanksContent = {
  title: "자가진단표, 확인하셨나요?",
  epiphany: `개업 1년차는 무면허운전, 2년차는 초보운전이었습니다.

그리고 3년차, 동시에 진행하던 인허가 3건에서 한꺼번에 문제가 터졌습니다. 4개월 동안 밤을 지새우며, 건축주님들께 고개를 들 수 없을 만큼 힘든 시간이었습니다.

그 안에서 깨달은 게 하나 있습니다 — 실력만으로는 부족하다는 것. 문제는 항상 "안 보이던 곳"에서 터진다는 것.

그래서 저는 실수를 줄이고 지연을 미리 막는 시스템을 만들기 시작했습니다. 지금도 계속 다듬고 있습니다.

그 고통스러운 4개월이 없었다면, 지금의 시스템도 없었을 겁니다.`,
  ceoSignoff: "(주)153시온건축사사무소 대표 건축사 김승호",
